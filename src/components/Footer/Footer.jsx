...
const Footer = () => {
    return (
        <footer className="bg-base-200 text-base-content p-6 sm:p-8 md:p-10 rounded-t-3xl shadow-inner">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-8 sm:gap-12">
                {/* Logo & Info */}
                <aside className="flex flex-col items-center sm:items-start text-center sm:text-left gap-3">
                    ...
                    <p className="text-sm sm:text-base mt-2">
                        GoBILLS
                        <br />
                        Reliable bill payment system since 1992
                    </p>
                </aside>

                {/* Contact Info */}
                <aside className="flex flex-col items-center sm:items-start text-center sm:text-left gap-2 sm:gap-3">
                    <h6 className="text-base sm:text-lg font-semibold mb-2">
                        Contact
                    </h6>
                    <p className="text-sm sm:text-base">
                        Email:{" "}
                        <a
                            href="mailto:support@gobills.com"
                            className="underline"
                        >
                            support@gobills.com
                        </a>
                    ...
                    <p className="text-sm sm:text-base">
                        Phone:{" "}
                        <a href="tel:+8801894217632" className="underline">
                            +880 1894 217 632
                        </a>
                    </p>
                    <p className="text-sm sm:text-base">
                        Address: 123 GoBills Street, Dhaka, Bangladesh
                    </p>
                </aside>
